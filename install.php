...
--
ALTER TABLE `system_options`
  MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1140;
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="form-group col-12">
                ...
                <input type="text" name="purchase_code" id="purchase_code" class="form-control" value="NullJungle" placeholder="NullJungle">
                <div class="invalid-feedback">
